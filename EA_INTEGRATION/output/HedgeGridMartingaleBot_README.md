# HedgeGridMartingaleBot.mq5 - Regime Filter Integration Complete (LOCAL)
...
1. Copy BOTH files to your MT5 Experts folder:
   - `HedgeGridMartingaleBot.mq5` (your integrated EA)
...
3. Drag `HedgeGridMartingaleBot.mq5` onto chart
