# CombinedHL_EPR_SwingSL_EA_v2.mq5 - Regime Filter Integration Complete (LOCAL)
...
1. Copy BOTH files to your MT5 Experts folder:
   - `CombinedHL_EPR_SwingSL_EA_v2.mq5` (your integrated EA)
...
3. Drag `CombinedHL_EPR_SwingSL_EA_v2.mq5` onto chart
