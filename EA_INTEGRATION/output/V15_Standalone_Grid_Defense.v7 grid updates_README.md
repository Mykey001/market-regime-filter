# V15_Standalone_Grid_Defense.v7 grid updates.mq5 - Regime Filter Integration Complete (LOCAL)
...
1. Copy BOTH files to your MT5 Experts folder:
   - `V15_Standalone_Grid_Defense.v7 grid updates.mq5` (your integrated EA)
...
3. Drag `V15_Standalone_Grid_Defense.v7 grid updates.mq5` onto chart
